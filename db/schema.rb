...
ActiveRecord::Schema[8.1].define(version: 2026_04_20_120000) do
  ...
  create_table "category_pie_configs", force: :cascade do |t|
    t.string "categories", default: [], null: false, array: true
    t.datetime "created_at", null: false
    t.string "name", null: false
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index "user_id, lower((name)::text)", name: "index_category_pie_configs_on_user_id_lower_name", unique: true
    t.index ["user_id"], name: "index_category_pie_configs_on_user_id"
  end
  ...
  add_foreign_key "category_pie_configs", "users"
